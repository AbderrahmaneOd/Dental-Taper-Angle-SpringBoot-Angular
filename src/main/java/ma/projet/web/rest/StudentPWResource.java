...
/**
 * REST controller for managing {@link ma.projet.domain.StudentPW}.
 */
@RestController
...
public class StudentPWResource {
     ...
     */
    @GetMapping("")
    public List<StudentPW> getAllStudentPWS(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<StudentPW> getStudentPW(@PathVariable Long id) {
