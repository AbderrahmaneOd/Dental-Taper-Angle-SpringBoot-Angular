      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            angleInterneG: expect.any(Object),
            angleInterneD: expect.any(Object),
            angleExterneG: expect.any(Object),
            angleExterneD: expect.any(Object),
            angledepouilleG: expect.any(Object),
            angledepouilleD: expect.any(Object),
            angleConvergence: expect.any(Object),
